...
namespace RestaurantManagement
{
    public partial class SubMeterialGroup : DevComponents.DotNetBar.Metro.MetroForm
    {
        ...
        public SubMeterialGroup(UserFunctionList userFunctionList)
        {
            InitializeComponent();
        ...
        private void SaveSubMeterialGroup()
        {
            ...
            try
            {
                ...
                LogHistories.InsertLogHistories("Chức năng tạo mới nhóm nguyên liệu", DateTime.Now, userFunctionList.UserName, "Thành công");
                reLoadData();
                MessageBox.Show("Tạo mới nhóm nguyên liệu thành công!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch(Exception ex)
            {
                LogHistories.InsertLogHistories("Chức năng tạo mới nhóm nguyên liệu", DateTime.Now, userFunctionList.UserName, ex.Message);
