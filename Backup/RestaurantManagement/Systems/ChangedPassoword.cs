...
{
    public partial class ChangedPassoword : DevComponents.DotNetBar.Metro.MetroForm
    {
        ...
        public ChangedPassoword(UserFunctionList userFunctionList)
        {
            InitializeComponent();
        ...
        public ChangedPassoword()
        {
            InitializeComponent();
        }

        private void ChangedPassoword_Load(object sender, EventArgs e)
        {
            panel1.CenterHorizontally();
            panel1.CenterVertically();
        }

        private void ChangedPassoword_SizeChanged(object sender, EventArgs e)
        {
            panel1.CenterHorizontally(); 
            panel1.CenterVertically();
        }
